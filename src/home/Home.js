        ...
        <div>
            <StyledJumbotron>
                ...
                <p className="text-center">
                    <Button variant="primary" href="https://www.jbcnconf.com/2020/covid19.html">COVID-19 change
                        dates</Button>
                </p>
                <p className="text-center">
                    <Button variant="info" href="https://www.jbcnconf.com/2020/callForPapers.html">Call for
                        papers</Button>&nbsp;
                    <Button variant="warning" href="https://tickets.jbcnconf.com/event/2020/">Buy your
                        ticket!</Button>&nbsp;
                    <Button variant="secondary" href="https://blog.jbcnconf.com/">visit our blog</Button>
                </p>
            </StyledJumbotron>
            <EventCountDown/>
        </div>
